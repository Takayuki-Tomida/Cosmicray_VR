...
//360viewで透明度情報を含むUIオブジェクトをキャプチャーするためのスクリプト
//Cameraにアタッチ
[RequireComponent(typeof(Camera))]
public class recordeUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        this.targetCamera.AddCommandBuffer(CameraEvent.AfterForwardAlpha, commandBuffer);
    }
