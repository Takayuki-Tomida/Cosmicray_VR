...
public class shower_takahashisann_forcapture : MonoBehaviour
{
    ...
    private IEnumerator coroutineR()
    {
        ...
        while (true)
        {
            ...
            EffectIntro20km.ShowerAdd(7.17f, 84.85f, -84.54f, 0, 0, 20, "Introshower_20km", 96, 115.2f);//西
            ...
            yield return new WaitForSeconds(13.5f);//小学生用ナレーションが終わるまで待つ

            //小学生ナレーション用
            //10km先
            EffectIntro10km_2.ShowerAdd(68.64f, 84.85f, 49.87f, 0, 0, -17, "Intro10km_2", 96, 115.2f);//南
            yield return new WaitForSeconds(7.35f);//10km先～20km先の間の時間

            //20km先
            EffectIntro10km_2.ShowerAdd(96.64f, 53.67f, 45.91f, 0, 0, 0, "Intro10km_3", 60, 72);//南
            yield return new WaitForSeconds(7.1f);//5s待機

            //40km先
            EffectIntro10km_2.ShowerAdd(105.7f, 29.1f, 47.78f, 0, 0, -20, "Intro10km_4", 30, 40);//南
            yield return new WaitForSeconds(7f);//5s待機

            //80km先
            EffectIntro10km_2.ShowerAdd(119f, 14.8f, 0f, 0, 0, 30, "Intro10km_5", 12, 20.8f);//南西
