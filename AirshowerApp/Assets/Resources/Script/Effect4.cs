...
{   //クラス名　変数名;　でインスタンスを格納する変数を定義
    ...
    {
        GameObject prefab = Resources.Load("Prefab_Realshower/pivotfixedshowers/" + name) as GameObject; //""内に参照フォルダ、ResourceはResourceフォルダ以下のみ参照
        ...
        g.transform.LookAt(new Vector3(0, 1184.85f, 0));//y軸に対して平行になるように一度向きを決める
