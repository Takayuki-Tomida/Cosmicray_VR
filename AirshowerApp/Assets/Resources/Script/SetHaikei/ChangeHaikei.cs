...
public class ChangeHaikei : MonoBehaviour
{
    public Material[] mat;
    public int flg = 0;
    public int laps = 0;
            ...
            while (s <= 140 || u <= 1420)
            {
                ...
                switch (flag_H % 2)
                {
                    ...
                    case 2:
                        ...
                        SphereL4.GetComponent<Renderer>().material.color = new Color(1, 1, 1, 1f);
                        SphereR3.GetComponent<Renderer>().material.color = new Color(1, 1, 1, 1f);
                        SphereR4.GetComponent<Renderer>().material.color = new Color(1, 1, 1, 1f);
                        ...
                        if(cnt == 0)
                        {
                            for (int i = 0; i <= 120; i++)
                            {
                                ...
                                SphereL2.GetComponent<Renderer>().material.color -= new Color(0, 0, 0, t);
                                SphereR.GetComponent<Renderer>().material.color -= new Color(0, 0, 0, t);
                                SphereR2.GetComponent<Renderer>().material.color -= new Color(0, 0, 0, t);
            ...
            while (s <= 140 || u <= 1420)
            {
                ...
                switch (flag_H % 2)
                {
                    ...
                    case 2:
                        ...
                        SphereL2.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 0f);
                        SphereR.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 0f);
                        SphereR2.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 0f);

                        SphereL3.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 1f);
                        SphereL4.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 1f);
                        SphereR3.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 1f);
                        SphereR4.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f, 1f);
