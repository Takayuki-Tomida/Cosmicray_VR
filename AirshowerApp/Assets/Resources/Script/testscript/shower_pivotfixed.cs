...
public class shower_pivotfixed : MonoBehaviour
{
    ...
    private IEnumerator coroutineR()
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                //Effect80km.ShowerAdd(104.326f, 14.8f, 57.244f, 0, -10, 0, "80kmshower", 13.86f, 20.8f);//南南西
                //Effect40km.ShowerAdd(101.424f, 29.1f, 56.295f, 0, 0, 0, "40kmshower", 25.33f, 42);//南南西
                //Effect20km.ShowerAdd(93.555f, 53.67f, 51.927f, 0, 0, 0, "20kmshower", 48, 76);//南南西
                //Effect10km.ShowerAdd(74.18f, 84.85f, 41.17f, 0, 10, 0, "10kmshower", 77, 118);//南南東
                //Effect5km.ShowerAdd(51.96f, 103.92f, 30f, 0, 0, 0, "5kmshower", 95, 142);//南南西

                //Effect20km.ShowerAdd(107f, 53.67f, 0f, 0, 0, 23, "20kmshower", 60, 72);//南西
                ...
                Effect80km.ShowerAdd(60.13f, 14.8f, -99.26f, 0, 0, -10, "80kmshower", 12, 20.8f);//西
                Effect80km.ShowerAdd(60.13f, 14.8f, -99.26f, 0, 0, 20, "80kmshower", 12, 20.8f);//西
                ...
                Effect40km.ShowerAdd(76.15f, 29.1f, -87.49f, 0, 0, 24, "40kmshower", 30, 40);//西
